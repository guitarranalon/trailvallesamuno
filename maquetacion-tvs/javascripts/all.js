...
(function($) {
	...
	if('undefined' === typeof $) {
		if('console' in window){ 
			window.console.info('Too much lightness, Featherlight needs jQuery.')/*RemoveLogging:skip*/;  }/*RemoveLogging:skip*/
		return;
	}
	...
	Featherlight.prototype = {
		...
		getContent: function(){
			...
			if(!filter) {
				...
				if(!data) {
					// Este error está comentado para evitar que el plugin de Grunt removelogging 
					// la elimine al realizar su tarea habitual, ya que el 'skip' no parece funcionar 
					// en este caso
					//if('console' in window){ 
					//	);/*RemoveLogging:skip*/ 
					//} /*RemoveLogging:skip*/
...
(function($) {
	...
	var warn = function(m) {
		if(window.console && window.console.warn) {	window.console.warn('FeatherlightGallery: ' + m);/*RemoveLogging:skip*/} /*RemoveLogging:skip*/
	};
    ...
    // c1nn Modificación para añadir pie de foto a partir del alt de la imagen
